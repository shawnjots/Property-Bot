//May need to work on this module to better handle numeric values entered for filtering 
using System;
    ...
    public class SearchRefineDialog : IDialog<FilterExpression>
    {
        ...
        public async Task StartAsync(IDialogContext context)
        {
            ...
            if (options.Any())
            {
                ...
                PromptOptions<string> promptOptions = new PromptOptions<string>(this.prompt, retry: "I did not understand, try one of these choices:", options: options.ToList(), promptStyler: new FacebookQuickRepliesPromptStyler());
